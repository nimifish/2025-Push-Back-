...
void skills() {
  ...
  chassis.pid_wait();
  chassis.pid_turn_set({77_in, 26_in}, rev, DRIVE_SPEED);
  chassis.pid_wait();
  chassis.pid_odom_set({{76.7_in, 26_in}, rev, DRIVE_SPEED});
  chassis.pid_wait();
  outtake();
  pros::delay(200);
  intakeUpperGoal();
  ...
  intakeHoard();
  littleSirWilliam.set_value(true);
  chassis.pid_odom_set({{113_in, 26_in}, fwd, 40});
  chassis.pid_wait();
  pros::delay(1000);
  chassis.pid_odom_set({{76.7_in, 26_in}, rev, DRIVE_SPEED});
  chassis.pid_wait();
  ...
  chassis.pid_wait();
  chassis.pid_turn_set({100_in, -69_in}, fwd, TURN_SPEED); 
  chassis.pid_wait();
  cut_intake();
  chassis.pid_odom_set({{100_in, -69_in}, fwd, DRIVE_SPEED}); // across the field
  chassis.pid_wait();
  chassis.pid_turn_set({114_in, -69_in}, fwd, TURN_SPEED);
  chassis.pid_wait();
  intakeHoard();
  littleSirWilliam.set_value(true);
  pros::delay(500);
  chassis.pid_odom_set({{114_in, -69_in}, fwd, 40});
  chassis.pid_wait();
  intakeHoard();
  pros::delay(1000);
  chassis.pid_odom_set({{102_in, -69_in}, rev, DRIVE_SPEED});
  chassis.pid_wait();
  littleSirWilliam.set_value(false);
  ...
  chassis.pid_turn_set({20_in, -83_in}, rev, TURN_SPEED);
  chassis.pid_wait();
  chassis.pid_odom_set({{20_in, -83_in}, rev, DRIVE_SPEED}); // MOVE FROM SIDE
  chassis.pid_wait();
  chassis.pid_turn_set({10_in, -69_in}, rev, TURN_SPEED);
  chassis.pid_wait();
  chassis.pid_odom_set({{10_in, -69_in}, rev, DRIVE_SPEED});
  chassis.pid_wait();
  chassis.pid_turn_set({26_in, -69_in}, rev, TURN_SPEED); // last long goal
  chassis.pid_wait();
  ...
  intakeHoard();
  littleSirWilliam.set_value(true);
  chassis.pid_odom_set({{-6_in, -69_in}, fwd, DRIVE_SPEED});
  chassis.pid_wait();
  pros::delay(1000);
  chassis.pid_odom_set({{26.3_in, -69_in}, rev, 40});
  chassis.pid_wait();
  ...
  chassis.pid_wait();
  cut_intake();
  chassis.pid_odom_set({{0_in, -69_in}, fwd, DRIVE_SPEED});
  chassis.pid_wait();
  chassis.pid_turn_set({-5_in, -54_in}, fwd, TURN_SPEED);
  chassis.pid_wait();
  chassis.pid_odom_set({{-5_in, -54_in}, fwd, DRIVE_SPEED});
  chassis.pid_wait();
  chassis.pid_swing_set(ez::LEFT_SWING, 90_deg, 90);
  descore_mech.set_value(true);
  intakeHoard();
  chassis.pid_turn_set({-10_in, -24_in}, fwd, TURN_SPEED);
  chassis.pid_wait();
  chassis.pid_odom_set({{-10_in, -24_in}, fwd, DRIVE_SPEED});
  chassis.pid_wait();
}
...
void skillsother() {
  ...
  // go to left loader
  chassis.pid_drive_set(52_in, 70, true);
  chassis.pid_wait();
  littleSirWilliam.set_value(true);
  ...
  chassis.pid_wait();
  littleSirWilliam.set_value(false);
  chassis.pid_turn_set(-225_deg, 50); 
  chassis.pid_wait();
  ...
  chassis.pid_wait();
  chassis.pid_turn_set(0_deg, 50); // get the park zone blocks
  chassis.pid_wait();
...
void soloAWP_lower() {
  ...
  chassis.pid_turn_set(-161_deg, 100); 
  chassis.pid_wait();
  intakeHoard();

  chassis.pid_drive_set(76_in, 90, true);
  chassis.pid_wait();
